...
The red diode within the RGB LED may be a bit brighter than the other two. To make your colors more balanced, use a higher ohm resistor. Or adjust in code. ```analogWrite(RED_PIN, redIntensity);```
to ```analogWrite(RED_PIN, redIntensity/3);```

###Questions

* What does the mainColors function do?
* What does the showRGB function do?
* What does the show Spectrum function do?
* How is it we can have 768 possible colors with this sketch?
* Describe how the analogWrite() function works.
<br>

<center>
[Experiment 2: Reading a Potentiometer](/pages/experiment-2-reading-a-potentiometer.html) | [Experiment 4: Driving Multiple LEDs](/pages/experiment-4-driving-multiple-leds.html)
