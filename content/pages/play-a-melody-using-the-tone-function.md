...
This example shows how to use the tone() command to generate notes. It plays a little melody you may have heard before.<br />
<div>
<br />
...
<li>piezo buzzer or a speaker</li>
<li>hook-up wires</li>
</ul>
<br />
<br />
...
<br /></div>
<div class="circuit" style="box-sizing: border-box; direction: ltr; margin: 0px; padding: 0px;">
<span style="font-size: large;">Schematic</span></div>
<div class="circuit" style="box-sizing: border-box; direction: ltr; margin: 0px; padding: 0px;">
<br /></div>
...
<br />
The main sketch is as follows:</div>
<div>
<br /></div>
<div>
<br /></div>
